...
(function () {
  ...
  function renderParsedTable(parsed) {
    ...
    h += '<tr><td class="intent-label">執飛機型</td><td class="intent-value">' + (parsed.aircraft_type ? escapeHtml(parsed.aircraft_type) : '—') + '</td><td class="intent-label">燃料單位</td><td class="intent-value">' + (parsed.fuel_unit ? escapeHtml(parsed.fuel_unit) : 'kgs') + '</td></tr>';
